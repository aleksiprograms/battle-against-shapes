...
public class PausedHud extends Hud {
    ...
    public PausedHud(TheGame game) {
        ...
        super.add(new Label("PAUSED", game.styles.skinLabelTitle1)).expandX().align(Align.top).colspan(2);
        super.row();
    ...
    public void init(long oldScore, long oldDistance) {
        ...
        labelBestScore.setText(game.styles.getFormattedScore(oldScore));
        labelBestDistance.setText(game.styles.getFormattedScore(oldDistance) + " m");
