 ...
 * the paths of the textures, the sounds and the particle effects.
 */
public class Constants {
    ...
    public static final short MASK_PLAYER =
            CATEGORY_ENEMY |
                    CATEGORY_ENEMY_AMMUNITION |
                    CATEGORY_GENERAL_PARTICLE |
                    CATEGORY_LEVEL_WALL |
                    CATEGORY_COLLECTIBLE |
                    CATEGORY_LEVEL_END_SENSOR;
    ...
    public static final short MASK_ENEMY =
            CATEGORY_PLAYER |
                    CATEGORY_PLAYER_AMMUNITION |
                    CATEGORY_ENEMY |
                    CATEGORY_GENERAL_PARTICLE |
                    CATEGORY_PLAYER_IGNORING_PARTICLE |
                    CATEGORY_LEVEL_WALL;
    ...
    public static final short MASK_LEVEL_WALL =
            CATEGORY_PLAYER |
                    ...
                    CATEGORY_GENERAL_PARTICLE |
                    CATEGORY_PLAYER_IGNORING_PARTICLE;
    public static final String FONT = "roboto_ttf/RobotoCondensed-Regular.ttf";
    public static final String TEXTURE_TEXTURE_ATLAS_BAS = "textures/texture_atlas_bas.atlas";
    public static final String TEXTURE_FIGHTER = "fighter";
    public static final String TEXTURE_BACKGROUND = "ui_background";
    public static final String TEXTURE_MACHINE_GUN = "weapon_machine_gun";
    public static final String TEXTURE_SHOTGUN = "weapon_shotgun";
    public static final String TEXTURE_FLAMETHROWER = "weapon_flamethrower";
    public static final String TEXTURE_KNIFE_THROWER = "weapon_knife_thrower";
    public static final String TEXTURE_GRENADE_LAUNCHER = "weapon_grenade_launcher";
    public static final String TEXTURE_ROCKET_LAUNCHER = "weapon_rocket_launcher";
    public static final String TEXTURE_DYNAMITE_LAUNCHER = "weapon_dynamite_launcher";
    public static final String TEXTURE_BLADE_LAUNCHER = "weapon_blade_launcher";
    public static final String TEXTURE_BULLET = "ammunition_bullet";
    public static final String TEXTURE_SHOT = "ammunition_shot";
    public static final String TEXTURE_KNIFE = "ammunition_knife";
    public static final String TEXTURE_GRENADE = "ammunition_grenade";
    public static final String TEXTURE_ROCKET = "ammunition_rocket";
    public static final String TEXTURE_DYNAMITE = "ammunition_dynamite";
    public static final String TEXTURE_BLADE = "ammunition_blade";
    public static final String TEXTURE_ENEMY_TRIANGLE = "enemy_triangle";
    public static final String TEXTURE_ENEMY_CIRCLE = "enemy_circle";
    public static final String TEXTURE_ENEMY_SQUARE = "enemy_square";
    public static final String TEXTURE_ENEMY_RECTANGLE = "enemy_rectangle";
    public static final String TEXTURE_ENEMY_ELLIPSE = "enemy_ellipse";
    public static final String TEXTURE_ENEMY_PENTAGON = "enemy_pentagon";
    public static final String TEXTURE_ENEMY_STAR = "enemy_star";
    public static final String TEXTURE_ENEMY_SEMICIRCLE = "enemy_semicircle";
    public static final String TEXTURE_UI_SCORE = "ui_score";
    public static final String TEXTURE_UI_DISTANCE = "ui_distance";
    public static final String TEXTURE_UI_STAR_UNLOCKED = "ui_star_unlocked";
    public static final String TEXTURE_UI_STAR_LOCKED = "ui_star_locked";
    public static final String TEXTURE_UI_BUTTON_MOVE_UP_U = "ui_button_move_up_u";
    public static final String TEXTURE_UI_BUTTON_MOVE_UP_D = "ui_button_move_up_d";
    public static final String TEXTURE_UI_BUTTON_MOVE_DOWN_U = "ui_button_move_down_u";
    public static final String TEXTURE_UI_BUTTON_MOVE_DOWN_D = "ui_button_move_down_d";
    public static final String TEXTURE_UI_BUTTON_USE_PRI_WEA_U = "ui_button_use_pri_wea_u";
    public static final String TEXTURE_UI_BUTTON_USE_PRI_WEA_D = "ui_button_use_pri_wea_d";
    public static final String TEXTURE_UI_BUTTON_USE_SEC_WEA_U = "ui_button_use_sec_wea_u";
    public static final String TEXTURE_UI_BUTTON_USE_SEC_WEA_D = "ui_button_use_sec_wea_d";
    public static final String TEXTURE_UI_BUTTON_STATS_U = "ui_button_stats_u";
    public static final String TEXTURE_UI_BUTTON_STATS_D = "ui_button_stats_d";
    public static final String TEXTURE_UI_BUTTON_SETTINGS_U = "ui_button_settings_u";
    public static final String TEXTURE_UI_BUTTON_SETTINGS_D = "ui_button_settings_d";
    public static final String TEXTURE_UI_BUTTON_CREDITS_U = "ui_button_credits_u";
    public static final String TEXTURE_UI_BUTTON_CREDITS_D = "ui_button_credits_d";
    public static final String TEXTURE_UI_BUTTON_PLAY_U = "ui_button_play_u";
    public static final String TEXTURE_UI_BUTTON_PLAY_D = "ui_button_play_d";
    public static final String TEXTURE_UI_BUTTON_HOME_U = "ui_button_home_u";
    public static final String TEXTURE_UI_BUTTON_HOME_D = "ui_button_home_d";
    public static final String TEXTURE_UI_BUTTON_PAUSE_U = "ui_button_pause_u";
    public static final String TEXTURE_UI_BUTTON_PAUSE_D = "ui_button_pause_d";
    public static final String TEXTURE_UI_BUTTON_REPLAY_U = "ui_button_replay_u";
    public static final String TEXTURE_UI_BUTTON_REPLAY_D = "ui_button_replay_d";
    public static final String TEXTURE_UI_RECTANGLE_BLACK = "ui_rectangle_black";
    public static final String TEXTURE_UI_RECTANGLE_GREY = "ui_rectangle_grey";
    public static final String TEXTURE_UI_RECTANGLE_BLUE = "ui_rectangle_blue";
    public static final String TEXTURE_UI_KNOB = "ui_knob";
    public static final String TEXTURE_UI_HEALTH_BAR_CONDITION = "ui_health_bar_condition";
    public static final String TEXTURE_UI_HEALTH_BAR_BACKGROUND = "ui_health_bar_background";
    public static final String TEXTURE_UI_HEALTH_BAR_END = "ui_health_bar_end";
    public static final String TEXTURE_UI_GAME_MODE_EASY = "game_mode_easy";
    public static final String TEXTURE_UI_GAME_MODE_MEDIUM = "game_mode_medium";
    public static final String TEXTURE_UI_GAME_MODE_HARD = "game_mode_hard";
    public static final String SOUND_BUTTON_POS = "sounds/button_pos.wav";
    public static final String SOUND_BUTTON_NEG = "sounds/button_neg.wav";
    public static final String SOUND_ENEMY_HIT = "sounds/enemy_hit.wav";
    public static final String SOUND_ENEMY_EXPLOSION = "sounds/enemy_explosion.wav";
    public static final String SOUND_ENEMY_AMMUNITION = "sounds/enemy_ammunition.wav";
    public static final String SOUND_BULLET = "sounds/bullet.wav";
    public static final String SOUND_SHOT = "sounds/shot.wav";
    public static final String SOUND_KNIFE = "sounds/knife.wav";
    public static final String SOUND_GRENADE = "sounds/grenade.wav";
    public static final String SOUND_ROCKET = "sounds/rocket.wav";
    public static final String SOUND_DYNAMITE_A = "sounds/dynamite_a.wav";
    public static final String SOUND_DYNAMITE_B = "sounds/dynamite_b.wav";
    public static final String SOUND_DYNAMITE_C = "sounds/dynamite_c.wav";
    public static final String SOUND_BLADE = "sounds/blade.wav";
    public static final String SOUND_EXPLOSION_SMALL_A = "sounds/explosion_small_a.wav";
    public static final String SOUND_EXPLOSION_SMALL_B = "sounds/explosion_small_b.wav";
    public static final String SOUND_EXPLOSION_SMALL_C = "sounds/explosion_small_c.wav";
    public static final String SOUND_EXPLOSION_BIG_A = "sounds/explosion_big_a.wav";
    public static final String SOUND_EXPLOSION_BIG_B = "sounds/explosion_big_b.wav";
    public static final String SOUND_EXPLOSION_BIG_C = "sounds/explosion_big_c.wav";
    public static final String PE_FIGHTER_EXPLOSION = "particle_effects/explosion_fighter.p";
    public static final String PE_FIGHTER_FLAME = "particle_effects/fighter_flame.p";
    public static final String PE_GRENADE_EXPLOSION = "particle_effects/explosion_grenade.p";
    public static final String PE_ROCKET_EXPLOSION = "particle_effects/explosion_rocket.p";
    public static final String PE_DYNAMITE_EXPLOSION = "particle_effects/explosion_dynamite.p";
    public static final String PE_GRENADE_SMOKE = "particle_effects/weapon_grenade_smoke.p";
    public static final String PE_ROCKET_SMOKE = "particle_effects/weapon_rocket_smoke.p";
    public static final String PE_DYNAMITE_FLAME = "particle_effects/weapon_dynamite_flame.p";
    public static final String PE_ENEMY_CIRCLE_EXPLOSION = "particle_effects/enemy_circle_explosion.p";
    public static final String PE_ENEMY_ELLIPSE_EXPLOSION = "particle_effects/enemy_ellipse_explosion.p";
    public static final String PE_ENEMY_PENTAGON_EXPLOSION = "particle_effects/enemy_pentagon_explosion.p";
    public static final String PE_ENEMY_RECTANGLE_EXPLOSION = "particle_effects/enemy_rectangle_explosion.p";
    public static final String PE_ENEMY_SEMICIRCLE_EXPLOSION = "particle_effects/enemy_semicircle_explosion.p";
    public static final String PE_ENEMY_SQUARE_EXPLOSION = "particle_effects/enemy_square_explosion.p";
    public static final String PE_ENEMY_STAR_EXPLOSION = "particle_effects/enemy_star_explosion.p";
    public static final String PE_ENEMY_TRIANGLE_EXPLOSION = "particle_effects/enemy_triangle_explosion.p";
    public static final String PE_ENEMY_CIRCLE_HIT = "particle_effects/enemy_circle_hit.p";
    public static final String PE_ENEMY_ELLIPSE_HIT = "particle_effects/enemy_ellipse_hit.p";
    public static final String PE_ENEMY_PENTAGON_HIT = "particle_effects/enemy_pentagon_hit.p";
    public static final String PE_ENEMY_RECTANGLE_HIT = "particle_effects/enemy_rectangle_hit.p";
    public static final String PE_ENEMY_SEMICIRCLE_HIT = "particle_effects/enemy_semicircle_hit.p";
    public static final String PE_ENEMY_SQUARE_HIT = "particle_effects/enemy_square_hit.p";
    public static final String PE_ENEMY_STAR_HIT = "particle_effects/enemy_star_hit.p";
    public static final String PE_ENEMY_TRIANGLE_HIT = "particle_effects/enemy_triangle_hit.p";
    private Constants() {
    }
}